...
def format_metric_html(
    ...
    color = get_color(value=value, metric_type=metric_type)
...
def run_retrieval_evaluation(progress=gr.Progress()):
    ...
    for test, result, progress_value in evaluate_all_retrieval():
        ...
        progress(progress=progress_value, desc=f"Evaluating test {count}...")
...
def run_answer_evaluation(progress=gr.Progress()):
    ...
    for test, result, progress_value in evaluate_all_answers():
        ...
        total_comleteness += result.completeness
    ...
    avg_completeness = total_comleteness / count
...
def main():
    ...
    with gr.Blocks(title="AG Evaluation Dashboard", theme=theme) as app:
        ...
        retrieval_button = gr.Button(value="Run Evaluation", variant="primary", size="lg")
        ...
        answer_button = gr.Button(value="Run Evaluation", variant="primary", size="lg")
